# -*- coding: utf-8 -*-
"""
Created on Wed Aug 18 14:07:50 2021
...
texto= open(f"Rendimiento Caso 1, longdouble.txt", "w")
...
text= open("Rendimiento Caso 1, longdouble.txt", "r")
info= text.read()
info= info.split("\n")
info.pop(0)
info.pop(-1)
